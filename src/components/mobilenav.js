...
const MobileNav = () => {
	...
	return (
		<>
			<MenuBar>
				<Link to="/"><img src={logodark} alt="NRS" className="logomark"/></Link>
				...
				<MenuLinks openMenu={openMenu}>
					<Link to="/"><img src={logostackeddark} alt="Nick Robinson Studio" className="logostacked"/></ Link>
					<ul>
						<li>
							<Link onClick={ () => setOpenMenu(!openMenu)} to="/works">Works</Link>
						</li>
						<li>
...
const MenuLinks = styled.nav `
	...
	a {
		font-family: 'YE-display', monospace;
		letter-spacing: .05em;
